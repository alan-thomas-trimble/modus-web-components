...
import * as ComponentStories from './modus-time-picker.stories';
...
<Story of={ComponentStories.TimeFormat} />
...
<Story of={ComponentStories.AutoFormat} />
...
<Story of={ComponentStories.WithTimeZone} />
