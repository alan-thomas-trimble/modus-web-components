...
import * as ComponentStories from './modus-toast.stories';
...
<Anchor of={ComponentStories.Primary} />

### Secondary

<modus-toast type="secondary">Secondary</modus-toast>

<Anchor of={ComponentStories.Secondary} />
...
<Anchor of={ComponentStories.Danger} />

### Retained Toast

<modus-toast type="primary" retain-element="true">Retained Toast</modus-toast>

<Anchor of={ComponentStories.RetainedToast} />
