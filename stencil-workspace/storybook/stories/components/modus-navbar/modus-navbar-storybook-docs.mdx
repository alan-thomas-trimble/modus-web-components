...
import * as ComponentStories from './modus-navbar.stories';
...
<Story of={ComponentStories.FailedAvatar} />
...
<Story of={ComponentStories.WithOptionalFeatures} />
...
<Story of={ComponentStories.BlueNavbar} />
