...
import * as ComponentStories from './modus-autocomplete.stories';
...
<Story of={ComponentStories.WithOption} />

### Multiple Selection

<Story of={ComponentStories.MultipleSelection} />

### With Custom Option

<Story of={ComponentStories.WithCustomOption} />

### With Dynamic Options

<Story of={ComponentStories.WithDynamicOptions} />
