...
import * as ComponentStories from './modus-switch.stories';
...
<Anchor of={ComponentStories.Medium} />

### Medium

<modus-switch label="Medium"></modus-switch>

<Anchor of={ComponentStories.Checked} />

### Small

<modus-switch label="Small" size="small"></modus-switch>

<Anchor of={ComponentStories.Small} />

### Checked

<modus-switch checked label="Checked"></modus-switch>

<Anchor of={ComponentStories.Disabled} />
