...
import * as ComponentStories from './modus-button.stories';
...
<Anchor of={ComponentStories.Borderless} />

### Borderless

<modus-button button-style="borderless">Borderless</modus-button>

<Anchor of={ComponentStories.Outline} />
...
<Anchor of={ComponentStories.IconWithText} />
...
<Anchor of={ComponentStories.IconOnly} />
...
<Anchor of={ComponentStories.WithCaret} />
